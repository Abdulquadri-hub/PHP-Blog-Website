...
foreach($categoryPosts as $categoryPost){
  // show($categoryPost['category_meta_keyword']);
    $page_title = $categoryPost['category_name'];
    $meta_description = $categoryPost['category_meta_description'];
    $meta_keywords = $categoryPost['category_meta_keyword'];
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9" data-aos="fade-up">
            ...
            <h3 class="category-title">Category: <?=$categoryPost['category_name'];?></h3>

            <div class="d-md-flex post-entry-2 half">
              <a href="<?= BASE_URL."/homepage/single-post.php?title=".$categoryPost['post_slug'];?>" class="me-4 thumbnail">
              ...
              <div>
                ...
                <h3><a href="<?= BASE_URL."/homepage/single-post.php?title=".$categoryPost['post_slug'];?>"><?=$categoryPost['post_title'];?></a></h3>
                <p><?=substr($categoryPost['post_description'], 0, 150), "...";?></p>
                <div class="d-flex align-items-center author">
                  <!-- <div class="photo"><img src="assets/img/person-2.jpg" alt="user" class="img-fluid"></div> -->
                  <div class="name">
            ...
            <?php endforeach; ?>
            <?php else: ?>
              <div>No Posts for this category yet!</div>
            <?php endif; ?>
          </div>
