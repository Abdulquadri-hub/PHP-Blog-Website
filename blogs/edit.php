...
<div class="container-fluid shadow mx-auto " style="max-width:1000px;">
    <h3 class="mb-4 card-subtitle">Edit Post</h3>
    ...
    <input value="<?=$post_id?>" type="hidden" name="id">
...
<label for="" class="form-label border-success border-start border-5">Image</label>
    <input type="file" value="<?=$post_image?>" class="form-control" name="post_image"  aria-label="file example" required>
    <div class="invalid-feedback">Example invalid form file feedback</div>
</div>

<div class="mb-3">
<label for="" class="form-label border-success border-start border-5">Slug</label>
    <input type="text" value="<?=$post_slug?>" class="form-control" name="post_slug"  aria-label="file example" required>
</div>

<div class="mb-3">
<label for="" class="form-label border-success border-start border-5">Meta Keyword</label>
    <input type="text" value="<?=$post_meta_keyword?>" class="form-control" name="post_meta_keyword"  aria-label="file example" required>
</div>

<div class="col-12">
    <div class="form-check">
    <?php if(empty($post_published) && $post_published == 0):?>
...
<input class="btn btn-outline-primary float-center text-secondary mx-5" name="update-post" type="submit" value="Save">
</div>
</form>
    </div> 
